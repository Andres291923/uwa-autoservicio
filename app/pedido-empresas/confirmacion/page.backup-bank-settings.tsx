...
const BANK_INFO = {
  ...
  accountNumber: "Número por definir",
      ...
      <section className="mx-auto max-w-4xl rounded-[2rem] bg-white p-8 shadow-sm">
        ...
        <div className="mt-6 rounded-[2rem] bg-emerald-50 p-6">
          ...
          <div className="mt-4 grid gap-3 text-sm font-bold md:grid-cols-2">
            <p><strong>Razón social:</strong> {BANK_INFO.businessName}</p>
            <p><strong>RUT:</strong> {BANK_INFO.rut}</p>
            <p><strong>Banco:</strong> {BANK_INFO.bank}</p>
            <p><strong>Tipo cuenta:</strong> {BANK_INFO.accountType}</p>
            <p><strong>N° cuenta:</strong> {BANK_INFO.accountNumber}</p>
            <p><strong>Correo:</strong> {BANK_INFO.email}</p>
          </div>
        </div>
