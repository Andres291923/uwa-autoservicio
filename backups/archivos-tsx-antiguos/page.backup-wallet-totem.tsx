    ...
    <main className="min-h-screen overflow-x-hidden bg-white pb-[112px] text-zinc-950">
      <header className="sticky top-0 z-40 border-b border-zinc-100 bg-white px-3 py-2 shadow-sm">
        <div className="flex h-[70px] items-center justify-between gap-3">
          ...
          {identifiedCustomer ? (
            <div className="shrink-0 rounded-2xl border border-emerald-200 bg-emerald-50 px-3 py-2 text-right shadow-sm">
              <p className="text-[9px] font-black uppercase tracking-[0.12em] text-emerald-700">
                Hola, {identifiedCustomer.name}
              </p>

              <p className="mt-1 text-[13px] font-black text-[#10B557]">
              ...
              <button
                ...
                className="mt-1 text-[8px] font-black uppercase text-zinc-500"
              >
                Cambiar
              </button>
            </div>
            ...
            <button
              ...
              className="shrink-0 rounded-2xl border border-emerald-200 bg-emerald-50 px-3 py-2 text-center shadow-sm"
            >
              <div
                className="mx-auto flex h-7 w-7 items-center justify-center rounded-xl text-[11px] font-black text-white"
