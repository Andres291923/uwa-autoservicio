...
function isBestSellerProduct(product: Product, index: number) {
  if (isBeverageProduct(product)) return false;

  const text = normalizeText(product.name);

  return index === 0 || text.includes("pollo") || text.includes("salmon");
}
          ...
          <section className="min-w-0 overflow-x-hidden bg-[#f7f8f4] p-4 pb-36">
            <div className="mb-4 overflow-hidden rounded-[2rem] bg-white p-5 shadow-[0_18px_45px_rgba(15,23,42,0.08)] ring-1 ring-black/5">
              <div className="flex items-center justify-between gap-4">
                ...
                <div
                  className="hidden rounded-[1.5rem] px-5 py-4 text-right text-white shadow-lg sm:block"
                  style={{ background: settings.primaryColor }}
                >
                      ...
                      >
                        <div className="relative mx-3 mb-2 flex h-[205px] min-h-[205px] items-center justify-center overflow-hidden rounded-[1.7rem] bg-white">
                          <div className="absolute left-3 top-3 z-10 flex flex-wrap gap-1.5">
                            {isBestSellerProduct(product, productIndex) && (
